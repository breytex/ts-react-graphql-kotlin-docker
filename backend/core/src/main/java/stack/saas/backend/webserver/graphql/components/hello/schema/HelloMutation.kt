...
import stack.saas.backend.webserver.graphql.components.hello.schema.directive.StringValidation
...
class HelloMutation @Inject constructor(private val helloRepo: HelloRepo) : GraphQLMutation {
    ...
    fun saveHello(@StringValidation(lowerCase = true, defaultString = "Fabian") value: String): Hello {
